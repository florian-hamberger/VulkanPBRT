...
void TerrainRayTracingSceneDescriptorCreationVisitor::apply(vsg::Object& object)
{
    object.traverse(*this);
}
void TerrainRayTracingSceneDescriptorCreationVisitor::apply(vsg::Transform& t)
{
...
void TerrainRayTracingSceneDescriptorCreationVisitor::apply(vsg::VertexIndexDraw& vid)
{
...
void TerrainRayTracingSceneDescriptorCreationVisitor::apply(vsg::StateGroup& sg)
{
...
void TerrainRayTracingSceneDescriptorCreationVisitor::apply(const vsg::Light& l)
{
    packedLights.push_back(l.getPacked());
}
void TerrainRayTracingSceneDescriptorCreationVisitor::updateDescriptor(vsg::BindDescriptorSet* descSet, const vsg::BindingMap& bindingMap)
{
